...
- Original sharp esports OBS screens with chamfered broadcast plates, crest-backed logo placement, advancement routes, and 1920x1080 reference thumbnails in `OBS Screen Thumbnails/`.
...
For group stages, use `Qualification Route` after Round 4. Focused round/lobby callouts are intentionally not part of the saved OBS package to avoid scene bloat.
